...
#define TARGET_SFI_NACL1 ((target_flags & MASK_SFI_NACL1) != 0)
...
enum opt_code
{
  ...
  OPT_mcallee_super_interworking = 994,      /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 995,      /* -mcaller-super-interworking */
  OPT_mcirrus_fix_invalid_insns = 996,       /* -mcirrus-fix-invalid-insns */
  OPT_mcpu_ = 997,                           /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 998,             /* -mfix-cortex-m3-ldrd */
  OPT_mfloat_abi_ = 999,                     /* -mfloat-abi= */
  OPT_mfp16_format_ = 1000,                  /* -mfp16-format= */
  /* OPT_mfp_2 = 1001, */                    /* -mfp=2 */
  /* OPT_mfp_3 = 1002, */                    /* -mfp=3 */
  OPT_mfpe = 1003,                           /* -mfpe */
  /* OPT_mfpe_2 = 1004, */                   /* -mfpe=2 */
  /* OPT_mfpe_3 = 1005, */                   /* -mfpe=3 */
  OPT_mfpu_ = 1006,                          /* -mfpu= */
  ...
  OPT_msfi_nacl1 = 1013,                     /* -msfi-nacl1 */
  ...
  OPT_time = 1110,                           /* -time */
  OPT_time_ = 1111,                          /* -time= */
  OPT_traditional = 1112,                    /* -traditional */
  OPT_traditional_cpp = 1113,                /* -traditional-cpp */
  OPT_trigraphs = 1114,                      /* -trigraphs */
  OPT_u = 1115,                              /* -u */
  OPT_undef = 1116,                          /* -undef */
  OPT_v = 1117,                              /* -v */
  OPT_version = 1118,                        /* -version */
  OPT_w = 1119,                              /* -w */
  OPT_wrapper = 1120,                        /* -wrapper */
  OPT_x = 1121,                              /* -x */
  OPT_z = 1122,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
