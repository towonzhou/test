...
#define HAVE_tls_load_dot_plus_eight (TARGET_ARM && !TARGET_SFI_NACL1)
#define HAVE_tls_load_dot_plus_eight_nacl (TARGET_ARM)
...
#define HAVE_consttable_sfi_barrier_4 (TARGET_SFI_NACL1)
#define HAVE_consttable_sfi_barrier_8 (TARGET_SFI_NACL1)
...
#define HAVE_trap (TARGET_SFI_NACL1)
...
#define HAVE_casesi ((TARGET_32BIT || optimize_size || flag_pic) && !TARGET_SFI_NACL1)
...
extern rtx        gen_tls_load_dot_plus_eight_nacl      (rtx, rtx, rtx);
...
extern rtx        gen_consttable_sfi_barrier_4          (void);
extern rtx        gen_consttable_sfi_barrier_8          (void);
