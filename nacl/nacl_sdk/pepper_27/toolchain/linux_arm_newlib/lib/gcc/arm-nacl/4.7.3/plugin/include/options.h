...
enum opt_code
{
  ...
  OPT_msfi_nacl1 = 1015,                     /* -msfi-nacl1 */
  ...
  OPT_time = 1113,                           /* -time */
  OPT_time_ = 1114,                          /* -time= */
  OPT_traditional = 1115,                    /* -traditional */
  OPT_traditional_cpp = 1116,                /* -traditional-cpp */
  OPT_trigraphs = 1117,                      /* -trigraphs */
  OPT_u = 1118,                              /* -u */
  OPT_undef = 1119,                          /* -undef */
  OPT_v = 1120,                              /* -v */
  OPT_version = 1121,                        /* -version */
  OPT_w = 1122,                              /* -w */
  OPT_wrapper = 1123,                        /* -wrapper */
  OPT_x = 1124,                              /* -x */
  OPT_z = 1125,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
